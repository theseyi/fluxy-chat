...
function getStateFromStore() {
  ...
  Object.keys(allMessages).map(function (messageKey) {
    var item = allMessages[messageKey];

    var messageLength = item.messages.length;
    return {
      lastMessage: item.messages[messageLength - 1],
